    ...
    *****************************/
    function init() {
        var mapOptions = {
            zoom: 16,
            scrollwheel: false,
            center: new google.maps.LatLng(39.73966540122949, 37.0349780387607),
        };
        var mapElement = document.getElementById('map');
        var map = new google.maps.Map(mapElement, mapOptions);
        var marker = new google.maps.Marker({
            position: new google.maps.LatLng(39.73966540122949, 37.0349780387607),
            map: map,
            icon: '/Content/Templates/GsoreTemplate/assets/img/icon/map-point.png',
